...
SRCS =	srcs/main.cpp srcs/UI/bar.cpp srcs/UI/battleUI.cpp srcs/UI/button.cpp srcs/UI/energy.cpp srcs/UI/number.cpp srcs/UI/statuses.cpp \
		...
		srcs/ow/owPlayer.cpp srcs/ow/owTools/owSpriteMover.cpp srcs/tools/AiThread.cpp \
		srcs/tools/deleteBattle.cpp srcs/ow/owTools/owCameraHandler.cpp srcs/ow/owTools/owThingUpdates.cpp
