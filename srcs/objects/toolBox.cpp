...
void ToolBox::InHandAbilities()
{
	...
	{
		character->abilities.push_back({THROW_TOOLBOX, 2, 15, 0, 200, StatStructs::THROWABLE, (-1), 0, 0, NULL});
	...
	{
		character->abilities.push_back({SUPPLY_ALLY, 3, 25, 0, 200, StatStructs::SUPPLY, (-1), 0, 0, NULL});
		int index = character->abilities.size() - 1;
