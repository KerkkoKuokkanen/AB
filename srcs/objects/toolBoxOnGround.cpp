...
void ToolBox::AssignDefaultOnGroundAbilities(Character *target)
{
	...
	{
		target->abilities.push_back({SUPPLY, 2, 0, 0, 200, StatStructs::SUPPLY, (-1), 0, 0, true, false, NULL});
	...
	{
		target->abilities.push_back({GENERIC_TOOL_THROW, 2, 15, 9, 200, StatStructs::THROWABLE, (-1), 0, 0, true, false, NULL});
		int index = target->abilities.size() - 1;
